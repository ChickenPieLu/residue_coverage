...
def visualise_e():
    ...
    # Load final model
    # The checkpoint contains the encoder too, so no download is needed here.
    ...
    cases = [
        {
            ...
            "file": str(utils.DATA_ROOT / "E" / "IMG_0940_part13")
        },
        {
            "name": "High-coverage overestimation",
            "file": str(utils.DATA_ROOT / "E" / "IMG_0938_part05")
        },
        {
